...
Pod::Spec.new do |s|
    s.name             = 'TripiFlightSdkConnector'
    s.version          = '0.0.3'
    s.summary          = 'TripiFlightSdkConnector framework'
  ...
  TODO: Add long description of the pod here.
    ...
    s.vendored_frameworks = 'TripiFlightSdkConnector.framework'
  
    s.public_header_files = 'TripiFlightSdkConnector.framework/Headers/*.h'
    s.source_files = 'TripiFlightSdkConnector.framework/Headers/*.{h, m, swift}'
